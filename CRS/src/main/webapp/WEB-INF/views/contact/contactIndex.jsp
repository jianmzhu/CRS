...
<link rel="stylesheet"
	href="${mybasePath}/resources/css/form-elements.css">
			...
			<div id="myTabContent" class="tab-content">
				<div class="tab-pane fade active in text-left" id="contact">
					...
					<p style="margin-left: 20px;">
						<span class="glyphicon glyphicon-phone-alt"></span>&nbsp;电话预约服务热线：020-xxxxxxxx
					</p>
					<p style="margin-left: 20px;">
						<span class="glyphicon glyphicon-globe"></span> &nbsp;网上预约挂号：<a
							href="#" target="_blank">http://www.xxx.cn</a>
					</p>
